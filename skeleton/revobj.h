...
private:
    ...
    /**
     * @brief Funcion que calcula los puntos del vertice
     * 
     * @param _vertex 
     * @return _vertex2f 
     */
...
public:
    ...
    /**
     * @brief draw
     * Funcion que construye la figura a partir de una funcion F(x)
     */
    void function_revobj(float (*_fx)(float _x),float _min,float _max,float _precision,unsigned int _n,bool _topclosed,bool _bottonclosed);
};
